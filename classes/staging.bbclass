# staging.bbclass override for meta-starry
# 
# 修复 Docker tmpfs 环境中的硬链接 EPERM 错误
# 当 os.link() 遇到 EPERM 时，回退到文件复制（与处理 EXDEV 相同）
#
# 原始文件: poky/meta/classes/staging.bbclass
# 修改内容: 将 "if err.errno == errno.EXDEV:" 
#          改为 "if err.errno == errno.EXDEV or err.errno == errno.EPERM:"
